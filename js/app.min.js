(() => {
    ...
    t.popup = new class {
        constructor(t) {
            ...
            this.youTubeCode, this.isOpen = !1, this.targetOpen = {
                ...
                selector: !1,
                element: !1
            }, this._dataValue = !1, this.hash = !1, this._reopen = !1, this._selectorOpen = !1, this.lastFocusEl = !1, this._focusEl = ["a[href]", 'input:not([disabled]):not([type="hidden"]):not([aria-hidden])', "button:not([disabled]):not([aria-hidden])", "select:not([disabled]):not([aria-hidden])", "textarea:not([disabled]):not([aria-hidden])", "area[href]", "iframe", "object", "embed", "[contenteditable]", '[tabindex]:not([tabindex^="-"])'], this.options = { ...e,
                ...t,
                classes: { ...e.classes,
                    ...t ? .classes
                },
                hashSettings: { ...e.hashSettings,
                    ...t ? .hashSettings
                },
                on: { ...e.on,
                    ...t ? .on
        ...
        close(t) {
            t && "string" == typeof t && "" !== t.trim() && (this.previousOpen.selector = t), this.isOpen && o && (this.options.on.beforeClose(this), document.dispatchEvent(new CustomEvent("beforePopupClose", {
                detail: {
                    popup: this
                }
    ...
    let c = (t, e = !1, o = 500, s = 0) => {
        ...
        if (n) {
            ...
            if (document.documentElement.classList.contains("menu-open") && i(), "undefined" != typeof SmoothScroll)(new SmoothScroll).animateScroll(n, "", l);
            else {
                let t = n.getBoundingClientRect().top + scrollY;
                t = c ? t - c : t, t = s ? t - s : t, window.scrollTo({
                    top: t,
                    behavior: "smooth"
                })
            }
                ...
                this.scrollWatcherLogging(`Прокинувся, стежу за об'єктами (${t.length})...`), r(Array.from(t).map((function(t) {
                    ...
                    let o = e.split("|"),
                        ...
                        n = Array.from(t).filter((function(t) {
                            ...
                            if (String(e) === s.root && String(o) === s.margin && String(n) === s.threshold) return t
                        })),
    ...
    class l {
        constructor(t) {
            t.length && (this.elements = Array.from(t).map((t => new l.Each(t, this.options))))
        }
        destroyEvents() {
    ...
    l.Each = class {
        ...
        animationFrame() {
            const t = this.parent.getBoundingClientRect().top,
                ...
                s = t - o,
                n = t + e,
                i = this.parent.dataset.prlxCenter ? this.parent.dataset.prlxCenter : "center";
            if (s < 30 && n > -30) switch (i) {
                case "top":
                    this.offset = -1 * t;
                    break;
                case "center":
    ...
    }, document.querySelectorAll("[data-prlx-parent]") && (t.parallax = new l(document.querySelectorAll("[data-prlx-parent]")));
    let h = !1;
    setTimeout((() => {
        if (h) {
    ...
    const u = document.querySelectorAll(".book-top-how-to-buy__item--front .book-top-how-to-buy__item-button"),
        d = document.querySelectorAll(".book-top-how-to-buy__item--back .book-top-how-to-buy__item-button"),
        p = window.innerWidth;
    u.forEach((t => {
        t.addEventListener("click", (() => {
            p > 767.98 ? (t.parentElement.parentElement.style.transformOrigin = "left", t.parentElement.parentElement.style.transform = "rotateY(-180deg)", t.parentElement.parentElement.classList.add("open")) : (t.parentElement.parentElement.style.transformOrigin = "top", t.parentElement.parentElement.style.transform = "rotateX(180deg)", t.parentElement.parentElement.classList.add("open"))
        }))
    })), d.forEach((t => {
        t.addEventListener("click", (() => {
            p > 767.98 ? (t.parentElement.parentElement.style.transformOrigin = "left", t.parentElement.parentElement.style.transform = "rotateY(0)", t.parentElement.parentElement.classList.remove("open")) : (t.parentElement.parentElement.style.transformOrigin = "top", t.parentElement.parentElement.style.transform = "rotateX(0)", t.parentElement.parentElement.classList.remove("open"))
        }))
    }));
    ...
    var y, v, E, L, A, O;
    w && (w.onclick = async function() {
            try {
                const t = "0xf6e932ca12afa26665dc4dde7e27be02a7c02e50";
                await navigator.clipboard.writeText(t), document.location.href = window.location.href + "#popup"
            } catch (t) {
                console.error(t.message)
            }
        }), y = window, v = document, E = "script", y.twq || ((L = y.twq = function() {
            L.exe ? L.exe.apply(L, arguments) : L.queue.push(arguments)
        }).version = "1.1", L.queue = [], (A = v.createElement(E)).async = !0, A.src = "https://static.ads-twitter.com/uwt.js", (O = v.getElementsByTagName(E)[0]).parentNode.insertBefore(A, O)), twq("config", "oiwln"), window.FLS = !1,
        function(t) {
            let e = new Image;
        ...
        function() {
                ...
                if ("click" === e.type) {
                    ...
                    if (o.closest("[data-goto]")) {
                        ...
                        if (t.fullpage) {
                            ...
                            null !== o && (t.fullpage.switchingSection(o), document.documentElement.classList.contains("menu-open") && i())
                        } else c(n, a, r, l);
                        e.preventDefault()
                    }
            ...
            if (document.addEventListener("click", o), document.addEventListener("watcherCallback", o), e()) {
                let t;
                document.querySelector(`#${e()}`) ? t = `#${e()}` : document.querySelector(`.${e()}`) && (t = `.${e()}`), t && c(t, !0, 500, 20)
            }
        }()
})();